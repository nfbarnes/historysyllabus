...
| Week 14 | Queer Activism: History in the Present | Read two current news articles about queer activism. You can also view a Ted Talk/news segment, listen to a podcast, or read poetry/fictional works about the current event. | | |Create: A website using HTML and CSS that addresses a current or past queer activist movement. |
